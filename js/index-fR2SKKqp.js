const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["js/Home-QgNUwQr0.js","js/vendor-CTSlEH4I.js","assets/css/vendor-C74l-vXi.css","assets/css/Home-_Y81wd2q.css","js/About-BMZpJ9qd.js","assets/css/About-B9A2magR.css","js/Article-Cvg24f2f.js","js/useNavigationLoading-lXx-8znu.js","js/MarkdownRenderer-CC4Zuliy.js","assets/css/MarkdownRenderer-DF5hhyd8.css","assets/css/Article-DlY1e1kl.css","js/Tools-Crn8ETI3.js","js/adminService-DrFsWwYf.js","assets/css/Tools-B42aRQQQ.css","js/Projects-BuLq0DOQ.js","js/projectService-BIbdkLaq.js","assets/css/Projects-BeMJZB09.css","js/Contact-Btz15D_s.js","assets/css/Contact-DFq_zc9z.css","js/Login-DhFYCif8.js","assets/css/Login-Dk2deyOB.css","js/Register-2RF0GA0F.js","assets/css/Register-BoUHuyIe.css","js/Profile-BPAy1diG.js","js/date-C7PCG7W7.js","assets/css/Profile-pp8-9vNR.css","js/Bookmarks-DqOtFWQK.js","assets/css/Bookmarks-B6fQzCTL.css","js/Tags-pJFZjLVX.js","assets/css/Tags-CjSc86qh.css","js/Categories-ByAfvwDn.js","assets/css/Categories-02xUKr1J.css","js/Search-BOIVyYqH.js","assets/css/Search-DifSrAfd.css","js/RagQA-CBZSU5u_.js","assets/css/RagQA-DR_qTQu3.css","js/Archive-D2_j69Xa.js","assets/css/Archive-CBXjKlML.css","js/Interview-R6nFrOdb.js","js/interviewService-8Vaw79gv.js","assets/css/Interview-ClLCWR73.css","js/InterviewCategory-Dt86ejNW.js","assets/css/InterviewCategory-CkEz34Og.css","js/InterviewQuestion-DHTLzdZY.js","assets/css/InterviewQuestion-ncd1ZF8w.css","js/Admin-BdsHg7CT.js","assets/css/Admin-DgX93Jt6.css","js/NotFound-DQKjBcsr.js","assets/css/NotFound-B9g3xXlq.css"])))=>i.map(i=>d[i]);
import{a as yn,d as an,r as D,c as P,u as vn,o as Y,b as bn,e as rn,f as M,g as _,h as s,i as T,k as f,w as y,l as E,E as sn,m as on,n as jn,p as Cn,q as wn,s as An,t as xn,v as Jn,x as en,y as Q,z as In,A as Ln,B as V,C as En,D as On,G as R,H as X,I as ln,J as Dn,K as kn,L as Tn,M as cn,N as Bn,O as Mn,P as Pn,Q as _n,T as tn,R as hn,S as Rn,U as Nn,V as Un,W as Fn,X as Vn}from"./vendor-CTSlEH4I.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const m of document.querySelectorAll('link[rel="modulepreload"]'))b(m);new MutationObserver(m=>{for(const h of m)if(h.type==="childList")for(const v of h.addedNodes)v.tagName==="LINK"&&v.rel==="modulepreload"&&b(v)}).observe(document,{childList:!0,subtree:!0});function a(m){const h={};return m.integrity&&(h.integrity=m.integrity),m.referrerPolicy&&(h.referrerPolicy=m.referrerPolicy),m.crossOrigin==="use-credentials"?h.credentials="include":m.crossOrigin==="anonymous"?h.credentials="omit":h.credentials="same-origin",h}function b(m){if(m.ep)return;m.ep=!0;const h=a(m);fetch(m.href,h)}})();const O={COMMENTS:"blog_comments",USERS:"blog_users",AUTH_TOKEN:"auth_token",CURRENT_USER:"blog_current_user",THEME:"blog_theme",ARTICLE_VIEWS:"blog_article_views",ARTICLE_LIKES:"blog_article_likes",LIKED_ARTICLES:"blog_liked_articles",BOOKMARKS:"blog_bookmarks",CONTACT_MESSAGES:"blog_contact_messages",CACHED_ARTICLES:"blog_cached_articles",CACHED_CATEGORIES:"blog_cached_categories",CACHED_ADMIN_STATS:"blog_cached_admin_stats",CACHED_ADMIN_COMMENTS:"blog_cached_admin_comments",CACHED_ADMIN_ARTICLE_STATS:"blog_cached_admin_article_stats"};function W(n,t=null){try{const a=localStorage.getItem(n);if(a==null)return t;try{return JSON.parse(a)}catch{return a}}catch(a){return console.error(`读取localStorage失败 (key: ${n}):`,a),t}}function U(n,t){try{return localStorage.setItem(n,JSON.stringify(t)),!0}catch(a){return console.error(`写入localStorage失败 (key: ${n}):`,a),!1}}function K(n){try{return localStorage.removeItem(n),!0}catch(t){return console.error(`删除localStorage失败 (key: ${n}):`,t),!1}}const Gn="modulepreload",Hn=function(n){return"/myBlog/"+n},un={},J=function(t,a,b){let m=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const v=document.querySelector("meta[property=csp-nonce]"),j=(v==null?void 0:v.nonce)||(v==null?void 0:v.getAttribute("nonce"));m=Promise.allSettled(a.map(C=>{if(C=Hn(C),C in un)return;un[C]=!0;const A=C.endsWith(".css"),w=A?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${C}"]${w}`))return;const g=document.createElement("link");if(g.rel=A?"stylesheet":Gn,A||(g.as="script"),g.crossOrigin="",g.href=C,j&&g.setAttribute("nonce",j),document.head.appendChild(g),A)return new Promise((I,x)=>{g.addEventListener("load",I),g.addEventListener("error",()=>x(new Error(`Unable to preload CSS for ${C}`)))})}))}function h(v){const j=new Event("vite:preloadError",{cancelable:!0});if(j.payload=v,window.dispatchEvent(j),!j.defaultPrevented)throw v}return m.then(v=>{for(const j of v||[])j.status==="rejected"&&h(j.reason);return t().catch(h)})},Kn="https://myblog-api-five.vercel.app",k=yn.create({baseURL:Kn,timeout:1e4,headers:{"Content-Type":"application/json"}});k.interceptors.request.use(n=>{const t=W(O.AUTH_TOKEN);return t&&(n.headers.Authorization=`Bearer ${t}`),n});k.interceptors.response.use(n=>n,n=>{var t;if(((t=n.response)==null?void 0:t.status)===401){K(O.AUTH_TOKEN),K(O.CURRENT_USER);const a=window.location.pathname;!a.includes("/login")&&!a.includes("/register")&&J(async()=>{const{default:b}=await Promise.resolve().then(()=>ct);return{default:b}},void 0).then(({default:b})=>{b.push("/login").catch(()=>{window.location.href="/login"})})}return Promise.reject(n)});function zn(n,t){return k.post("/api/auth/login",{username:n,password:t})}function qn(n,t){return k.post("/api/auth/register",{username:n,password:t})}function nn(){return k.get("/api/auth/profile")}function $n(n){return k.put("/api/auth/avatar",{image:n})}function Qn(){return k.delete("/api/auth/avatar")}const fn=an("auth",()=>{const n=W(O.CURRENT_USER),t=D(n),a=D(W(O.AUTH_TOKEN,null)),b=D(!1),m=P(()=>!!a.value&&!!t.value),h=P(()=>{var u;return((u=t.value)==null?void 0:u.role)==="admin"});function v(u,e){a.value=e,t.value=u,U(O.AUTH_TOKEN,e),U(O.CURRENT_USER,u)}function j(){a.value=null,t.value=null,K(O.AUTH_TOKEN),K(O.CURRENT_USER)}async function C(u,e){var l,d;b.value=!0;try{const r=await zn(u,e);return r.data.success?(v(r.data.data.user,r.data.data.token),{success:!0,user:r.data.data.user}):{success:!1,message:r.data.message||"登录失败"}}catch(r){return{success:!1,message:((d=(l=r.response)==null?void 0:l.data)==null?void 0:d.message)||"登录失败，请检查网络连接"}}finally{b.value=!1}}async function A(u,e){var l,d;b.value=!0;try{const r=await qn(u,e);return r.data.success?(v(r.data.data.user,r.data.data.token),{success:!0,user:r.data.data.user}):{success:!1,message:r.data.message||"注册失败"}}catch(r){return{success:!1,message:((d=(l=r.response)==null?void 0:l.data)==null?void 0:d.message)||"注册失败，请检查网络连接"}}finally{b.value=!1}}async function w(){if(!a.value)return!1;b.value=!0;try{const u=await nn();return u.data.success?(t.value=u.data.data,U(O.CURRENT_USER,u.data.data),!0):(j(),!1)}catch{return j(),!1}finally{b.value=!1}}function g(){j()}async function I(u){const e=await $n(u);if(e.data.success)try{const l=await nn();l.data.success&&(t.value=l.data.data,U(O.CURRENT_USER,l.data.data))}catch{t.value={...t.value,avatarUrl:e.data.data.avatarUrl},U(O.CURRENT_USER,t.value)}return e.data}async function x(){const u=await Qn();if(u.data.success)try{const e=await nn();e.data.success&&(t.value=e.data.data,U(O.CURRENT_USER,e.data.data))}catch{t.value={...t.value,avatarUrl:null},U(O.CURRENT_USER,t.value)}return u.data}return{user:t,token:a,loading:b,isAuthenticated:m,isAdmin:h,login:C,register:A,restoreSession:w,logout:g,updateAvatarUrl:I,removeAvatarUrl:x}});function Xn(){const n=fn(),t=P(()=>n.user),a=P(()=>n.isAuthenticated),b=P(()=>n.isAdmin);function m(w,g){return n.login(w,g)}function h(w,g){return n.register(w,g)}function v(){n.logout()}function j(){return n.restoreSession()}function C(w){return n.updateAvatarUrl(w)}function A(){return n.removeAvatarUrl()}return{currentUser:t,isAuthenticated:a,isAdmin:b,login:m,register:h,logout:v,restoreSession:j,updateAvatar:C,removeAvatar:A}}const Z=(n,t)=>{const a=n.__vccOpts||n;for(const[b,m]of t)a[b]=m;return a},Wn={class:"header-content"},Yn={class:"header-center"},Zn={class:"nav-link more-link"},ne={class:"header-right"},ee={class:"search-box"},te={class:"auth-zone"},ae={class:"user-info-trigger"},re={class:"user-name"},ie={class:"dropdown-user-header"},se={class:"name"},oe={class:"role"},le={__name:"Header",setup(n){const t=vn(),{currentUser:a,logout:b,isAuthenticated:m,isAdmin:h}=Xn(),v=D(""),j=P(()=>a.value?a.value.avatarUrl?a.value.avatarUrl:`https://api.dicebear.com/7.x/pixel-art/svg?seed=${a.value.username}`:""),C=()=>{if(!v.value.trim()){ln.warning("请输入搜索关键词");return}t.push(`/search?q=${encodeURIComponent(v.value)}`),v.value=""},A=u=>{switch(u){case"profile":t.push("/profile");break;case"bookmarks":t.push("/bookmarks");break;case"admin":t.push("/admin");break;case"logout":g();break}},w=u=>{switch(u){case"tools":t.push("/tools");break;case"interview":t.push("/interview");break;case"rag":t.push("/rag");break;case"about":t.push("/about");break}},g=()=>{Dn.confirm("确定要退出登录吗？","退出确认",{confirmButtonText:"确定",cancelButtonText:"取消",type:"warning"}).then(()=>{b(),ln.success("已退出登录"),t.push("/login")}).catch(()=>{})},I=D(!1),x=()=>{I.value=window.scrollY>20};return Y(()=>window.addEventListener("scroll",x)),bn(()=>window.removeEventListener("scroll",x)),(u,e)=>{const l=rn("router-link"),d=sn,r=Cn,c=jn,L=wn,N=Jn,G=In,F=En,z=On;return M(),_("header",{class:X(["blog-header",{"is-scrolled":I.value}])},[s("div",Wn,[s("div",{class:"header-left",onClick:e[0]||(e[0]=B=>T(t).push("/"))},[...e[3]||(e[3]=[s("span",{class:"logo-bracket"},"[",-1),s("span",{class:"logo-text"},"myBlog",-1),s("span",{class:"logo-cursor"},"_",-1),s("span",{class:"logo-bracket"},"]",-1)])]),s("nav",Yn,[f(l,{to:"/",class:"nav-link"},{default:y(()=>[...e[4]||(e[4]=[s("span",{class:"nav-bracket"},"[",-1),E(" 首页 ",-1),s("span",{class:"nav-bracket"},"]",-1)])]),_:1}),f(l,{to:"/archive",class:"nav-link"},{default:y(()=>[...e[5]||(e[5]=[s("span",{class:"nav-bracket"},"[",-1),E(" 归档 ",-1),s("span",{class:"nav-bracket"},"]",-1)])]),_:1}),f(l,{to:"/categories",class:"nav-link"},{default:y(()=>[...e[6]||(e[6]=[s("span",{class:"nav-bracket"},"[",-1),E(" 分类 ",-1),s("span",{class:"nav-bracket"},"]",-1)])]),_:1}),f(l,{to:"/projects",class:"nav-link"},{default:y(()=>[...e[7]||(e[7]=[s("span",{class:"nav-bracket"},"[",-1),E(" 项目 ",-1),s("span",{class:"nav-bracket"},"]",-1)])]),_:1}),f(l,{to:"/tags",class:"nav-link"},{default:y(()=>[...e[8]||(e[8]=[s("span",{class:"nav-bracket"},"[",-1),E(" 标签 ",-1),s("span",{class:"nav-bracket"},"]",-1)])]),_:1}),f(L,{trigger:"hover",onCommand:w},{dropdown:y(()=>[f(c,null,{default:y(()=>[f(r,{command:"tools"},{default:y(()=>[...e[12]||(e[12]=[E("> 实用工具",-1)])]),_:1}),f(r,{command:"interview"},{default:y(()=>[...e[13]||(e[13]=[E("> 面试题库",-1)])]),_:1}),f(r,{command:"rag"},{default:y(()=>[...e[14]||(e[14]=[E("> AI 问答",-1)])]),_:1}),f(r,{command:"about"},{default:y(()=>[...e[15]||(e[15]=[E("> 关于我",-1)])]),_:1})]),_:1})]),default:y(()=>[s("span",Zn,[e[9]||(e[9]=s("span",{class:"nav-bracket"},"[",-1)),e[10]||(e[10]=E(" 更多 ",-1)),e[11]||(e[11]=s("span",{class:"nav-bracket"},"]",-1)),f(d,null,{default:y(()=>[f(T(on))]),_:1})])]),_:1})]),s("div",ne,[s("div",ee,[f(N,{modelValue:v.value,"onUpdate:modelValue":e[1]||(e[1]=B=>v.value=B),placeholder:"搜索文章...","prefix-icon":T(xn),clearable:"",onKeyup:An(C,["enter"]),class:"search-input"},null,8,["modelValue","prefix-icon"])]),s("div",te,[T(m)?(M(),_(en,{key:0},[f(F,{content:"管理后台",placement:"bottom",effect:"dark"},{default:y(()=>[T(h)?(M(),Q(G,{key:0,type:"primary",circle:"",icon:T(Ln),onClick:e[2]||(e[2]=B=>T(t).push("/admin"))},null,8,["icon"])):V("",!0)]),_:1}),f(L,{onCommand:A,trigger:"click"},{dropdown:y(()=>[f(c,null,{default:y(()=>{var B;return[s("div",ie,[s("p",se,R((B=T(a))==null?void 0:B.username),1),s("p",oe,R(T(h)?"管理员":"普通用户"),1)]),f(r,{command:"profile"},{default:y(()=>[...e[16]||(e[16]=[E("> 个人中心",-1)])]),_:1}),f(r,{command:"bookmarks"},{default:y(()=>[...e[17]||(e[17]=[E("> 我的收藏",-1)])]),_:1}),T(h)?(M(),Q(r,{key:0,command:"admin"},{default:y(()=>[...e[18]||(e[18]=[E("> 管理后台",-1)])]),_:1})):V("",!0),f(r,{divided:"",command:"logout",class:"logout-item"},{default:y(()=>[...e[19]||(e[19]=[E(" > 退出登录 ",-1)])]),_:1})]}),_:1})]),default:y(()=>{var B;return[s("div",ae,[f(z,{size:32,src:j.value},null,8,["src"]),s("span",re,R((B=T(a))==null?void 0:B.username),1),f(d,null,{default:y(()=>[f(T(on))]),_:1})])]}),_:1})],64)):(M(),_(en,{key:1},[f(l,{to:"/login",class:"nav-link"},{default:y(()=>[...e[20]||(e[20]=[E("[ 登录 ]",-1)])]),_:1}),f(l,{to:"/register",class:"nav-link accent"},{default:y(()=>[...e[21]||(e[21]=[E("[ 注册 ]",-1)])]),_:1})],64))]),e[22]||(e[22]=s("span",{class:"status-indicator"},"状态: 运行中",-1))])])],2)}}},ce=Z(le,[["__scopeId","data-v-0a48a945"]]);function ue(n={}){return k.get("/api/articles",{params:n})}function pt(n){return k.get(`/api/articles/${n}`)}function de(){return k.get("/api/categories")}function pe(){return k.get("/api/stats")}function gt(){return k.get("/api/tags")}function ge(n){return k.post("/api/search",{query:n})}const me=[{id:"Ajax",title:"Ajax",date:"2026-05-06",tags:[],categories:[],excerpt:`Ajax笔记\r
\r
Ajax：异步的JavaScript和XMLAsynchronous JavaScript And XML。简单来说，就是使用XMLHttpRequest对象与服务器通信。它可以...`,cover:"/myBlog/images/article-default.jpg",published:!0,content:`# Ajax笔记\r
\r
Ajax：异步的JavaScript和XML(Asynchronous JavaScript And XML)。简单来说，**就是使用XMLHttpRequest对象与服务器通信。**它可以使用JSON,XML,HTML和text文本等格式发送和接收数据。Ajax最吸引人的就是它的"异步特性"，也就是说它可以在不重新刷新页面的情况下与服务器通信，交换数据，或更新页面。\r
\r
# axios使用\r
\r
语法：\r
\r
1. 引入axios.js:https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js\r
2. 使用axios函数\r
   1. 传入配置对象\r
   2. 再用.then回调函数接收结果，并做后续处理\r
\r
~~~JavaScript\r
axios({\r
  url:'目标资源地址'\r
...
## URL查询参数\r
\r
定义：浏览器提供给服务器的**额外信息**，让服务器返回想要的数据\r
\r
语法：http://xxxx.com/xxx/xxx?参数名1=值1&参数名2=值2\r
\r
### axios-查询参数\r
\r
语法：使用axios提供的**params选项**\r
\r
> 查看数据时使用查询参数params选项\r
\r
城市列表：http://hmajax.itheima.net/api/city?pname=河北省\r
\r
~~~JavaScript\r
axios({\r
  url:'http://hmajax.itheima.net/api/city',\r
  params:{\r
    pname:'河北省'\r
  }\r
}).then(result=>{\r
...
### 常用请求方法\r
\r
请求方法：对服务器**资源**，要执行的**操作**\r
\r
|    请求方法     |                    操作                     |\r
| :-------------: | :-----------------------------------------: |\r
| <u>**GET**</u>  |  <u>**获取数据**</u>（请求数据有大小限制）  |\r
| <u>**POST**</u> | <u>**提交数据**</u>（请求数据没有大小限制） |\r
|       PUT       |               修改数据(全部)                |\r
|     DELETE      |                  删除数据                   |\r
|      PATCH      |               修改数据(部分)                |\r
\r
url:请求的URL网址\r
\r
method：请求的方法，GET可以省略(不区分大小写)\r
\r
**data：提交数据**（大括号是因为是对象，如果本来就是对象就不用加大括号）\r
\r
![71444820041](/myBlog/images/1714448200418.png)\r
\r
### 错误处理\r
\r
场景：再次注册相同的账号，会遇到报错信息\r
\r
处理：用更直观的方式，给普通用户展示错误信息\r
\r
语法：在then方法后面，通过点语法调用catch方法，传入回调函数并定义形参\r
\r
~~~JavaScript\r
axios({\r
  // 请求选项\r
...
## HTTP协议-请求报文\r
\r
HTTP协议：规定了浏览器发送及服务器返回内容的**格式**\r
\r
**请求报文**：浏览器按照HTTP协议要求的**格式**，发送给服务器的**内容**。\r
\r
### 请求报文的格式\r
\r
请求报文的组成部分有：\r
\r
1. **请求行：请求方法，URL**，协议\r
2. **请求头**：以键值对的格式携带的附加信息，比如：**Content-Type**\r
3. 空行：分隔请求头，空行之后的是发送给服务器的资源\r
4. **请求体：发送的资源**\r
\r
### 请求数据格式\r
\r
#### 请求行（请求数据第一行）\r
\r
包含请求方式、资源路径、协议，相互之间使用一个空格来进行分离\r
\r
#### 请求头（键值对格式）\r
\r
![73535962540](/myBlog/images/1735359625409.png)\r
\r
|      Host       |                         请求的主机名                         |\r
| :-------------: | :----------------------------------------------------------: |\r
|   User-Agent    | 浏览器版本，例如Chrome浏览器的标识类似Mozilla/5.0 ... Chrome/79,IE浏览器类似Mozilla/5.0(Windows NT ...)like Gecko |\r
|     Accept      | 表示浏览器能接收到的资源类型，如\` text/* \`，\` image/* \`或者\` */* \`表示所有 |\r
| Accept-Language |    表示浏览器偏好的语言，服务器可以据此返回不同语言的网页    |\r
| Accept-Encoding |     表示浏览器可以支持的压缩类型，例如\` gzip,deflate \`等     |\r
|  Content-Type   |                      请求主体的数据类型                      |\r
| Content-Length  |                 请求主体的大小（单位：字节）                 |\r
\r
#### 请求体\r
\r
在请求头下方先有空行再有请求体，一般用于处理post请求的参数，来存放请求参数\r
\r
\r
\r
### 请求报文-报错排查\r
\r
需求： 通过请求报文排查错误原因，并修复\r
\r
## HTTP-响应报文：\r
\r
**响应报文**：服务器按照HTTP协议要求的**格式**，返回给浏览器的**内容**\r
\r
1. **响应行(状态行)**：协议、**HTTP响应状态码**、状态信息\r
2. **响应头**：以键值对的格式携带的附加信息,比如：**Cotent-Type**\r
3. 空行：分隔响应行，空行之后是服务器返回的资源\r
4. **响应体：返回的资源**\r
\r
### 响应格式\r
\r
...
##### 响应状态码\r
\r
| 1xx  | 响应中-临时状态码，表示请求已经接收，告诉客户端应该连续请求或者如果它已经完成则忽略它 |\r
| :--: | :----------------------------------------------------------: |\r
| 2xx  |          成功-表示请求已经被成功接收，处理已经完成           |\r
| 3xx  | 重定向-重定向到其他地方；让客户端再发起一次请求以完成整个处理 |\r
| 4xx  | 客户端错误-处理发生错误，责任在客户端。如：请求了不存在的资源、客户端未被授权、禁止访问等。 |\r
| 5xx  |  服务器错误-处理发生错误，责任在服务端。如：程序抛出异常等   |\r
\r
##### 常见的响应状态码\r
\r
| 状态码  | 英文描述                                | 解释                                                         |\r
| :-----: | --------------------------------------- | ------------------------------------------------------------ |\r
| **200** | **\` OK \`**                              | 客户端请求成功，即**处理成功**，这是我们最想看到的状态码     |\r
|   302   | **\` Found \`**                           | 指示所请求的资源已移动到由**\` Location \`**响应头给定的URL，浏览器会自动重新访问到这个页面 |\r
|   304   | **\` Not Modified \`**                    | 告诉客户端，你请求的资源至上次取得后，服务端并未更改，你直接用你本地缓存吧。隐式重定向 |\r
|   400   | **\` Bad Request \`**                     | 客户端请求由语法错误，不能被服务器理解                       |\r
|   403   | **\` Forbidden \`**                       | 服务器收到请求，但是**拒绝提供服务**，比如：没有权限访问相关资源 |\r
| **404** | **\` Not Found \`**                       | **请求资源不存在**，一般是URL输入有误，或者网站资源被删除了  |\r
|   405   | **\` Method Not Allowed \`**              | 请求方式有误，比如应该用GET请求方式的资源用了POST            |\r
|   428   | **\` Precondition Required \`**           | **服务器要求由条件的请求**，告诉客户端要想访问该资源，必须携带特定的请求头 |\r
|   429   | **\` Too Many Requests \`**               | 指示用户在给定时间内发送了太多请求(“限速”),配合Retry-After（多长时间后可以请求）响应头一起使用 |\r
|   431   | **\` Request Header Fields Too Large \`** | **请求头太大**，服务器不愿意处理请求，因为它的头部字段太大，请求可以在减少请求头域的大小后重新提交 |\r
| **500** | **\` Internal Server Error \`**           | **服务器发生不可预期的错误。**服务器出异常了，赶紧看日志去吧 |\r
|   503   | **\` Service Unavailable \`**             | **服务器尚未准备好处理请求**，服务器刚刚启动，还未初始化好   |\r
\r
\r
\r
##### 响应头内的对应内容\r
\r
|   Content-Type   | 表示该响应内容的类型，例如：\` text/html \`,\` application/json \` |\r
| :--------------: | :----------------------------------------------------------: |\r
|  Content-Length  |                表示该响应内容的长度（字节数）                |\r
| Content-Encoding |             表示该响应\` 压缩算法 \`，例如\` gzip \`             |\r
|  Cache-Control   | 指示客户端应如何缓存，例如\` max-age=300 \`表示可以\` 最多缓存300秒 \` |\r
|    Set-Cookie    |          告诉浏览器为\` 当前页面所在的域设置cookie \`          |\r
\r
\r
\r
#### 响应体\r
...
基于TCP协议：面向连接，安全\r
\r
基于请求-响应模型的：一次请求对应一次响应\r
\r
HTTP协议是无状态的协议：对于事务处理没有记忆能力。每次请求-响应都是独立的。\r
\r
​	缺点：多次请求不能共享数据\r
\r
​	优点：速度快\r
...
描述**接口**的文章（后端工程师）\r
\r
**接口：**使用Ajax和服务器通讯时，使用的**URL，请求方法，以及参数**\r
\r
**传送门：AJAX阶段接口文档**（http://apifox.cn/apidoc/project-1937884/doc-1695440）\r
\r
## form-serialize插件\r
\r
作用：**快速**收集表单元素的值\r
...
\r
~~~JavaScript\r
const form = document.querySelector('.example-form')\r
// 参数1：要获取哪个表单的数据		 		参数2：配置对象\r
	/*	参数1:需要获取表单的那个数据\r
				表单设置name属性,值会作为对象的属性名\r
				建议name的值与接口文档参数保持一致\r
			参数2:配置对象\r
				hash : 设置获取数据类型\r
					true JS对象(推荐) 一般请求体里提交给服务器\r
					false : 查询字符串\r
				empth : 设置是否获取空值\r
					true: 获取空值(推荐) 数据结构和标签结构一致\r
					false: 不获取空值\r
					*/\r
const data = serialize(form,{hash: true,empty: true})\r
~~~\r
\r
## bootstrap插件\r
\r
作用：省略一部分css样式和JS代码\r
\r
去官网查询相关内容并使用。\r
\r
## ！！！Ajax原理-XMLHttpRequest\r
\r
定义：XMLHttpRequest（XHR）对象用于与服务器交互。通过XMLHttpRequest可以在不刷新页面的情况下请求特定URL，获取数据。这允许网页在不影响用户操作的情况下，更新页面的布局内容。XMLHttpRequest在AJAX编程中被大量使用。\r
\r
关系：axios内部采用XMLHttpRequest与服务器交互\r
\r
### 使用XHR\r
\r
步骤：\r
...
### XHR查询参数\r
\r
定义：浏览器提供给服务器的**额外信息**，让服务器返回浏览器想要的数据\r
\r
语法：http://xxxx.com/xxx/xxx?参数名1=值1&参数名2=值2\r
\r
多个查询参数时可以使用的语法：\r
\r
~~~JavaScript\r
// 1.创建URLSearchParams对象\r
const paramsObj = new URLSearchParams({\r
  参数名1: 值1，\r
  参数名2: 值2\r
})\r
// 2.生成指定格式查询参数  字符串\r
const queryString = paramsObj.toString()\r
// 结果：参数名1=值1&参数名2=值2\r
~~~\r
\r
### XHR数据提交\r
\r
相关语法：\r
\r
**请求头**设置Content-Type：application/json\r
\r
**请求体**携带JSON字符串\r
\r
~~~JavaScript\r
...
\r
// 告诉服务器，我传递的内容类型 ，是JSON字符串\r
xhr.setRequestHeader('Content-Type','application/json')\r
// 准备数据并转成JSON字符串\r
const user = {username:'itheima007',password:'7654321'}\r
const userStr = JSON.stringify(user)\r
// 发送请求体数据\r
xhr.send(userStr)\r
~~~\r
\r
### Promise\r
\r
定义：Promise对象用于表示一个异步操作的最终完成(或失败)及其结果值\r
\r
好处：\r
\r
1. 逻辑更清晰\r
...
const p = new Promise((resolve,reject)=>{\r
  // 2.执行异步任务-并传递结果\r
  // 成功调用：resolve（值）触发then（）执行\r
  // 失败调用：reject（值） 触发catch（）执行\r
})\r
// 3.接收结果\r
p.then(result =>{\r
  // 成功\r
...
#### Promise三种状态\r
\r
作用：了解Promise对象如何关联的处理函数，以及代码执行顺序\r
\r
概念：一个Promise对象，必然处于以下几种状态之一\r
\r
待定（pending）		：初始状态，既没有被兑现，也没有被拒绝\r
\r
已兑现（fulfilled）		：意味着，操作成功完成\r
\r
已拒绝（rejected）		：意味着，操作失败\r
\r
![71488693403](/myBlog/images/1714886934037.png)\r
\r
> 注意：Promise对象一旦被兑现/拒绝就是已敲定了，状态无法再被改变\r
\r
## 同步代码和异步代码\r
\r
### 同步代码：\r
\r
代码是从上到下一行一行的执行，浏览器等代码的解析和工作，在上一行完成后才执行下一行代码，这样就成为了一个**同步程序**，\r
\r
> 逐行执行，需原地等待结果后，才继续向下执行\r
\r
### 异步代码：\r
\r
在执行一个长期运行的任务的同时执行其他的代码，不必等待上一行的代码执行完成\r
\r
> 调用后耗时，不阻塞代码继续执行，在将来完成后触发一个回调函数接收结果\r
\r
## 回调函数地狱\r
\r
概念：在回调函数中嵌套回调函数，一直嵌套下去就形成了回调函数地狱\r
\r
缺点：可读性差，异常无法捕获，耦合性严重，牵一发动全身\r
\r
### promise链式调用解决回调函数地狱问题：\r
\r
#### Promise链式调用概念：\r
\r
依靠then()方法会返回一个新生成的Promise对象特性，继续串联下一环任务，直到结束\r
\r
> 细节：then()回调函数中的返回值，会影响新生成的Promise对象最终状态和结果\r
\r
> 好处：通过链式调用，解决回调函数嵌套的问题\r
\r
![71498303055](/myBlog/images/1714983030552.png)\r
\r
#### 解决方法：\r
\r
做法：每个Promise对象中管理一个异步任务，用then返回Promise对象，串联起来\r
\r
![71504255409](/myBlog/images/1715042554099.png)\r
\r
## async函数和await（在其父级使用async函数，配合await原地拿到相关信息）\r
\r
定义：async函数是使用async关键字声明的函数。async函数是AsyncFunction构造函数的实例，并且其中允许使用await关键字async和await关键字让我们可以用一种更简洁的方式写出基于Promise对象的异步行为，而无需刻意地链式调用Promise。\r
\r
概念：在async函数内，使用await关键字取代then函数，等待获取Promise对象成功状态的结果值\r
\r
示例如下：![71521744907](/myBlog/images/1715217449073.png)\r
\r
### async函数和await错误捕获\r
\r
使用：try...catch\r
\r
try...catch语句标记要尝试的语句块，并指定一个出现异常时抛出的响应。\r
\r
语法：\r
\r
~~~JavaScript\r
try{\r
  ...
  // error 接收的是错误信息\r
  // try里代码，如果有错误，直接进入这里执行\r
}\r
~~~\r
\r
## 事件循环（EventLoop）\r
\r
概念：JavaScript有一个基于事件循环的并发模型，事件循环负责执行代码、收集和处理事件以及执行任务队列中的子任务。这个模型与其他语言中的截然不同，比如c和Java。\r
\r
原因：JavaScript单线程(某一刻只能执行一行代码)，为了让耗时代码不阻塞其他代码运行，设计了**<u>事件循环模型</u>**\r
\r
定义：执行代码和收集异步任务的模型，在调用栈空闲，反复调用任务队列里回调函数的执行机制，就叫事件循环\r
\r
## 宏任务与微任务\r
\r
ES6之后引入了Promise对象，让JS引擎也可以发起异步任务\r
\r
**异步任务**分为：\r
\r
### 消息队列(宏任务)：\r
\r
由**<u>浏览器</u>**环境执行的异步代码\r
\r
|       任务(代码)        | 执行所在环境 |\r
| :---------------------: | :----------: |\r
| JS脚本执行事件(script)  |    浏览器    |\r
| setTimeout、setInterval |    浏览器    |\r
|    AJAX请求完成事件     |    浏览器    |\r
|     用户交互事件等      |    浏览器    |\r
\r
### 微任务(优先级为最高)：\r
\r
由**<u>JS引擎</u>**环境执行的异步代码\r
\r
|     任务(代码)     | 执行所在环境 |\r
| :----------------: | :----------: |\r
| Promise对象.then() |    JS引擎    |\r
\r
Promise本身是同步的，而then和catch**<u>回调函数</u>**是异步的\r
\r
![71522552125](/myBlog/images/1715225521250.png)\r
\r
## Promise.all静态方法\r
\r
概念：合并多个Promise对象，等待所有**<u>同时成功</u>**完成(或某一个失败)，做后续逻辑\r
\r
> 将多个Promise对象合并为一个新的Promise对象\r
\r
![71522654726](/myBlog/images/1715226547260.png)\r
\r
语法：\r
\r
~~~JavaScript\r
const p = new Promise.all([Promise对象，Promise对象，...])\r
p.then(result =>{\r
  // result结果：[Promise对象成功结果，Promise对象成功结果，...]\r
}).catch(error =>{\r
  // 第一个失败的Promise对象，抛出的异常\r
})\r
~~~\r
\r
## 基地址：(统一配置一般不需要进行更改多次)\r
\r
作用：提取公共前缀地址，配置后axios请求时都会baseURL + url\r
\r
示例如下：\r
\r
> axios.defaults.baseURL = 'http://geek.itheima.net'\r
\r
## token的介绍\r
\r
概念：访问权限的**<u>令牌</u>**，本质上是一串**<u>字符串</u>**\r
\r
创建：正确登录后，由后端签发并返回\r
\r
![71556778526](/myBlog/images/1715567785269.png)\r
\r
作用：判断是否有**<u>登录状态</u>**等，控制返回权限\r
\r
![71557080108](/myBlog/images/1715570801086.png)\r
\r
> 注意：**前端**只能判断token**有无**，而**后端**才能判断token的**有效性**\r
\r
## axios请求拦截器：（将所有的请求参数一并进行配置，避免更改时的麻烦）\r
\r
发起请求之前，触发的配置函数，对请求参数进行额外配置\r
\r
> 当出现请求头的传递数据时进行相关配置，可以去相关网站上查找直接复制并进行一些操作。传送门：[拦截器 | Axios中文文档 | Axios中文网 (axios-http.cn)](https://www.axios-http.cn/docs/interceptors)\r
\r
![71557310816](/myBlog/images/1715573108163.png)\r
\r
> 写法是固定的，注意在请求拦截器中的那个bearer与token之间的空格不能省略，还要进行return\r
>\r
> axios.interceptors.request.use(config =>{\r
>\r
> ​	const token = localStorage.getItem('token')\r
>\r
> ​	token && (config.headers.Authorization = \`Bearer \${token}\`)\r
>\r
> ​	// 在发送请求之前做些什么\r
>\r
> ​	return config\r
...
## axios响应拦截器：\r
\r
响应回到then/catch之前，触发的**拦截函数**，对**响应结果统一处理**\r
\r
![71557944167](/myBlog/images/1715579441674.png)\r
\r
> 相关解释：其中的？表示有没有值，因为有时候error里并没有response，所以如果不写，程序没有找到就会报错，401一般是表示登录过期，error就能相应的接收相关代码\r
>\r
> 这里是将相关操作统一进行设置，避免代码的冗余\r
\r
![71558075350](/myBlog/images/1715580753502.png)\r
\r
## 发布文章-富文本编辑器（wang-editor)\r
\r
富文本：带样式，多格式的文本，在前端一般使用标签配合内联样式实现\r
\r
富文本编辑器：用于编写富文本内容的容器\r
\r
![71558168342](/myBlog/images/1715581683424.png)`},{id:"bigdecimal",title:"BigDecimal 详解",date:"2026-05-06",tags:[],categories:[],excerpt:`《阿里巴巴 Java 开发手册》中提到：“为了避免精度丢失，可以使用 BigDecimal 来进行浮点数的运算”。
...
java
flo...`,cover:"/myBlog/images/article-default.jpg",published:!0,content:`《阿里巴巴 Java 开发手册》中提到：“为了避免精度丢失，可以使用 \`BigDecimal\` 来进行浮点数的运算”。
...
<!-- @include: @article-footer.snippet.md -->`},{id:"generics-and-wildcards",title:"泛型&通配符详解",date:"2026-05-06",tags:[],categories:[],excerpt:`泛型

 什么是泛型？有什么作用？

Java 泛型（Generics） 是 JDK 5 中引入的一个新特性。使用泛型参数，可以增强代码的可读性以及稳定性。如无特别说明，以下行为以 Java 8 为...`,cover:"/myBlog/images/article-default.jpg",published:!0,content:`## 泛型
...
- Java 基础 一文搞懂泛型：https://www.cnblogs.com/XiiX/p/14719568.html`},{id:"how-sql-executed-in-mysql",title:"SQL语句在MySQL中的执行过程",date:"2026-05-06",tags:[],categories:[],excerpt:`> 本文来自木木匠https://github.com/kinglaw1204投稿。

本篇文章会分析下一个 SQL 语句在 MySQL 中的执行流程，包括 SQL 的查询在 MySQL 内部会怎么流...`,cover:"/myBlog/images/article-default.jpg",published:!0,content:`> 本文来自[木木匠](https://github.com/kinglaw1204)投稿。
...
<!-- @include: @article-footer.snippet.md -->`},{id:"java-basic-questions-01",title:"Java基础常见面试题总结(上)",date:"2026-05-06",tags:[],categories:[],excerpt:`<-- @include: @small-advertisement.snippet.md -->
...
1. 简单易学（语法简单，上手容易）；
2....`,cover:"/myBlog/images/article-default.jpg",published:!0,content:`<!-- @include: @small-advertisement.snippet.md -->
...
<!-- @include: @article-footer.snippet.md -->`},{id:"java-basic-questions-02",title:"Java基础常见面试题总结(中)",date:"2026-05-06",tags:[],categories:[],excerpt:`<-- @include: @article-header.snippet.md -->

 面向对象基础

 ⭐️面向对象和面向过程的区别

面向过程编程（Procedural-Oriented P...`,cover:"/myBlog/images/article-default.jpg",published:!0,content:`<!-- @include: @article-header.snippet.md -->
...
<!-- @include: @article-footer.snippet.md -->`},{id:"java-basic-questions-03",title:"Java基础常见面试题总结(下)",date:"2026-05-06",tags:[],categories:[],excerpt:`<-- @include: @small-advertisement.snippet.md -->

 异常

Java 异常类层次结构图概览：

Java 异常类层次结构图https://oss.j...`,cover:"/myBlog/images/article-default.jpg",published:!0,content:`<!-- @include: @small-advertisement.snippet.md -->
...
<!-- @include: @article-footer.snippet.md -->`},{id:"java-keyword-summary",title:"Java 关键字总结",date:"2026-05-06",tags:[],categories:[],excerpt:`final,static,this,super 关键字总结

 final 关键字

final 关键字，意思是最终的、不可修改的，最见不得变化 ，用来修饰类、方法和变量，具有以下特点：

1. f...`,cover:"/myBlog/images/article-default.jpg",published:!0,content:`# final,static,this,super 关键字总结
...
<!-- @include: @article-footer.snippet.md -->`},{id:"proxy",title:"Java 代理模式详解",date:"2026-05-06",tags:[],categories:[],excerpt:`1. 代理模式

代理模式是一种比较好理解的设计模式。简单来说就是 我们使用代理对象来代替对真实对象real object的访问，这样就可以在不修改原目标对象的前提下，提供额外的功能操作，扩展目标对...`,cover:"/myBlog/images/article-default.jpg",published:!0,content:`## 1. 代理模式
...
<!-- @include: @article-footer.snippet.md -->`},{id:"rag-basis",title:"万字详解 RAG 基础概念",date:"2026-05-06",tags:[],categories:[],excerpt:`<-- @include: @article-header.snippet.md -->

去年面字节的时候，面试官问我：“你们项目里的知识库问答是怎么做的？” 我说：“直接调 OpenAI 的 AP...`,cover:"/myBlog/images/article-default.jpg",published:!0,content:`<!-- @include: @article-header.snippet.md -->
...
RAG 是连接 LLM 与企业知识的桥梁，理解它的工作原理和适用边界，比追逐最新框架更实在。`},{id:"reflection",title:"Java 反射机制详解",date:"2026-05-06",tags:[],categories:[],excerpt:`何为反射？

如果说大家研究过框架的底层原理或者咱们自己写过框架的话，一定对反射这个概念不陌生。

反射之所以被称为框架的灵魂，主要是因为它赋予了我们在运行时分析类以及执行类中方法的能力。

通过反...`,cover:"/myBlog/images/article-default.jpg",published:!0,content:`## 何为反射？
...
<!-- @include: @article-footer.snippet.md -->`},{id:"serialization",title:"Java 序列化详解",date:"2026-05-06",tags:[],categories:[],excerpt:`什么是序列化和反序列化?

如果我们需要持久化 Java 对象比如将 Java 对象保存在文件中，或者在网络传输 Java 对象，这些场景都需要用到序列化。

简单来说：

- 序列化：将数据结构或...`,cover:"/myBlog/images/article-default.jpg",published:!0,content:`## 什么是序列化和反序列化?
...
<!-- @include: @article-footer.snippet.md -->`},{id:"spi",title:"Java SPI 机制详解",date:"2026-05-06",tags:[],categories:[],excerpt:"> 本文来自 Kingshionhttps://github.com/jjx0708 投稿。欢迎更多朋友参与到 JavaGuide 的维护工作，这是一件非常有意义的事情。详细信息请看：JavaGuid...",cover:"/myBlog/images/article-default.jpg",published:!0,content:`> 本文来自 [Kingshion](https://github.com/jjx0708) 投稿。欢迎更多朋友参与到 JavaGuide 的维护工作，这是一件非常有意义的事情。详细信息请看：[JavaGuide 贡献指南](https://javaguide.cn/javaguide/contribution-guideline.html) 。
...
<!-- @include: @article-footer.snippet.md -->`},{id:"syntactic-sugar",title:"Java 语法糖详解",date:"2026-05-06",tags:[],categories:[],excerpt:`> 作者：Hollis
>
> 原文：<https://mp.weixin.qq.com/s/o4XdEMq1DL-nBS-f8Za5Aw>

语法糖是大厂 Java 面试常问的一个知识点。

本文从...`,cover:"/myBlog/images/article-default.jpg",published:!0,content:`> 作者：Hollis
>
> 原文：<https://mp.weixin.qq.com/s/o4XdEMq1DL-nBS-f8Za5Aw>
...
<!-- @include: @article-footer.snippet.md -->`},{id:"unsafe",title:"Java 魔法类 Unsafe 详解",date:"2026-05-06",tags:[],categories:[],excerpt:`> 本文整理完善自下面这两篇优秀的文章：
>
> - Java 魔法类：Unsafe 应用解析 - 美团技术团队 -2019https://tech.meituan.com/2019/02/14/ta...`,cover:"/myBlog/images/article-default.jpg",published:!0,content:`> 本文整理完善自下面这两篇优秀的文章：
>
...
<!-- @include: @article-footer.snippet.md -->`},{id:"why-there-only-value-passing-in-java",title:"Java 值传递详解",date:"2026-05-06",tags:[],categories:[],excerpt:`开始之前，我们先来搞懂下面这两个概念：
...
- 实参（实际参数，Argumen...`,cover:"/myBlog/images/article-default.jpg",published:!0,content:`开始之前，我们先来搞懂下面这两个概念：
...
<!-- @include: @article-footer.snippet.md -->`},{id:"localstorage-web-app",title:"基于localStorage的Web应用数据持久化",date:"2026-04-01",tags:["localStorage","数据持久化","前端"],categories:["前端开发"],excerpt:"探索在前端应用中使用localStorage进行数据持久化的最佳实践。",cover:"/images/article5.jpg",published:!0,content:`# 基于localStorage的Web应用数据持久化\r
\r
localStorage是浏览器提供的本地存储方案。\r
\r
## localStorage API\r
\r
\`\`\`javascript\r
...
\r
// 读取数据\r
const value = localStorage.getItem('key');\r
\r
// 删除数据\r
...
2. 仅支持字符串类型\r
3. 同源策略限制\r
4. 无过期时间`},{id:"static-site-generation",title:"静态网站生成与部署",date:"2026-03-20",tags:["Vite","部署","GitHub Pages"],categories:["部署","前端开发"],excerpt:"如何使用Vite构建静态网站并部署到GitHub Pages。",cover:"/images/article4.jpg",published:!0,content:`# 静态网站生成与部署\r
\r
静态网站具有速度快、安全性高、成本低等优点。\r
\r
## 为什么选择静态网站\r
\r
- 极快的加载速度\r
...
2. 配置GitHub Pages\r
3. 推送构建文件\r
4. 访问你的网站`},{id:"element-plus-tutorial",title:"Element Plus 组件库使用教程",date:"2026-03-05",tags:["Element Plus","UI","组件库"],categories:["前端开发"],excerpt:"学习如何使用Element Plus快速构建美观的Vue 3应用。",cover:"/images/article3.jpg",published:!0,content:`# Element Plus 组件库使用教程\r
\r
Element Plus是一个基于Vue 3的组件库，提供了丰富的UI组件。\r
\r
## 安装\r
\r
\`\`\`bash\r
...
\`\`\`vue\r
<template>\r
  <el-button type="primary">主要按钮</el-button>\r
</template>\r
\`\`\``},{id:"vue3-composition-api",title:"Vue 3 Composition API 入门指南",date:"2026-02-10",tags:["Vue","Composition API","前端"],categories:["前端开发"],excerpt:"深入理解Vue 3 Composition API的核心概念和用法。",cover:"/images/article2.jpg",published:!0,content:`# Vue 3 Composition API 入门指南\r
\r
Composition API是Vue 3的核心特性之一。\r
\r
## 什么是Composition API\r
\r
Composition API 是一种新的代码组织方式，允许你更好地组织和重用代码逻辑。\r
\r
### 优势\r
\r
1. 更好的逻辑复用\r
2. 更灵活的类型推断\r
3. 更清晰的代码结构`},{id:"hello-world",title:"Hello World",date:"2026-01-15",tags:["Vue","JavaScript","教程"],categories:["前端开发"],excerpt:"这是我的第一篇博客文章，介绍Vue 3的基本概念。",cover:"/images/article1.jpg",published:!0,content:`# Hello World\r
\r
欢迎来到我的博客！这是我的第一篇文章。\r
\r
## 内容简介\r
\r
本文将介绍博客的基本功能和特点。`}],ve=5*60*1e3;function dn(n,t=ve){try{const a=W(n);if(!a)return null;const{data:b,timestamp:m}=a;return Date.now()-m>t?(K(n),null):b}catch{return null}}function pn(n,t){U(n,{data:t,timestamp:Date.now()})}function gn(n){K(n)}const Sn=an("article",()=>{const n=D([]),t=D([]),a=D(!1),b=D(0),m=D(0),h=D(null),v=5*60*1e3;function j(o){return{...o,id:o.slug||o.id,date:o.created_at,excerpt:o.summary,cover:o.cover_image,categories:o.category_name?[o.category_name]:[]}}async function C(o=!1){if(h.value)return h.value;if(!o&&n.value.length>0&&Date.now()-b.value<v)return;const i=dn(O.CACHED_ARTICLES);i&&i.length>0&&(n.value=i,a.value=!1),n.value.length===0&&(a.value=!0,n.value=me.map(S=>({...S,views:0,likes:0,categories:Array.isArray(S.categories)?S.categories:S.category?[S.category]:["未分类"]})),a.value=!1);const p=(async()=>{try{const S=await ue({limit:100});S.data.success&&(n.value=S.data.data.map(j),pn(O.CACHED_ARTICLES,n.value),b.value=Date.now())}catch{}finally{h.value=null}})();return h.value=p,p}async function A(o=!1){if(!o&&t.value.length>0&&Date.now()-m.value<v)return;const i=dn(O.CACHED_CATEGORIES);i&&i.length>0&&(t.value=i);try{const p=await de();p.data.success&&(t.value=p.data.data.map(S=>({id:S.slug,name:S.name,count:S.article_count,slug:S.slug})),pn(O.CACHED_CATEGORIES,t.value),m.value=Date.now())}catch{}}function w(){return n.value.filter(o=>o.status!=="draft").sort((o,i)=>new Date(i.date||i.created_at)-new Date(o.date||o.created_at))}function g(o){return n.value.find(i=>i.id===o||i.slug===o)||null}function I(o){if(!o.trim())return[];const i=o.toLowerCase();return w().filter(p=>{const S=Array.isArray(p.tags)?p.tags:[],H=Array.isArray(p.categories)?p.categories:[];try{return(p.title||"").toLowerCase().includes(i)||(p.excerpt||p.summary||"").toLowerCase().includes(i)||(p.content||"").toLowerCase().includes(i)||S.some(q=>String(q).toLowerCase().includes(i))||H.some(q=>String(q).toLowerCase().includes(i))}catch{return(p.title||"").toLowerCase().includes(i)||(p.excerpt||p.summary||"").toLowerCase().includes(i)}})}const x=P(()=>{const o={};return w().forEach(i=>{(Array.isArray(i.tags)?i.tags:[]).forEach(S=>{o[S]=(o[S]||0)+1})}),Object.entries(o).sort((i,p)=>p[1]-i[1]).slice(0,10).map(([i,p])=>({tag:i,count:p}))}),u=P(()=>{const o={};return w().forEach(i=>{const p=new Date(i.date||i.created_at),S=`${p.getFullYear()}-${String(p.getMonth()+1).padStart(2,"0")}`;o[S]||(o[S]={year:p.getFullYear(),month:p.getMonth()+1,key:S,articles:[]}),o[S].articles.push(i)}),Object.values(o).sort((i,p)=>p.year-i.year||p.month-i.month)});function e(){return w().reduce((o,i)=>o+(i.view_count||i.views||0),0)}function l(o){return w().filter(i=>(Array.isArray(i.tags)?i.tags:[]).some(S=>String(S).toLowerCase()===String(o).toLowerCase()))}function d(o){const i=String(o).toLowerCase();return w().filter(p=>p.category_slug&&String(p.category_slug).toLowerCase()===i?!0:(Array.isArray(p.categories)?p.categories:p.category_name?[p.category_name]:[]).some(H=>{const q=typeof H=="object"?H.name||H.slug:H;return String(q).toLowerCase()===i}))}async function r(o){const i=await ge(o);if(i.data.success)return i.data.data;throw new Error(i.data.message||"语义搜索失败")}function c(o){const i=w(),p=i.findIndex(S=>S.id===o||S.slug===o);return{previous:p>0?i[p-1]:null,next:p<i.length-1?i[p+1]:null}}function L(){b.value=0,m.value=0,gn(O.CACHED_ARTICLES),gn(O.CACHED_CATEGORIES)}async function N(o){const i=await N(o);if(i.data.success){const p=n.value.find(S=>S.slug===o||S.id===o);return p&&(p.likes=i.data.data.likes,p.liked=i.data.data.liked),{liked:i.data.data.liked,likes:i.data.data.likes}}return null}async function G(o){try{const i=await G(o);return i.data.success?i.data.data:{likes:0,liked:!1}}catch{return{likes:0,liked:!1}}}async function F(o){const i=await F(o);if(i.data.success){const p=n.value.find(S=>S.slug===o||S.id===o);return p&&(p.bookmarked=i.data.data.bookmarked),{bookmarked:i.data.data.bookmarked}}return null}async function z(o){try{const i=await z(o);return i.data.success?i.data.data:{bookmarks:0,bookmarked:!1}}catch{return{bookmarks:0,bookmarked:!1}}}async function B(){try{const o=await B();return o.data.success?o.data.data:[]}catch{return[]}}return{articles:n,categories:t,loading:a,loadArticles:C,loadCategories:A,getAllArticles:w,getArticleById:g,searchArticles:I,getPopularTags:x,getArticlesByArchive:u,getPreviousNextArticles:c,getArticlesByTag:l,getArticlesByCategory:d,getTotalViews:e,invalidateCache:L,toggleLike:N,getLikeStatus:G,toggleBookmark:F,getBookmarkStatus:z,getBookmarks:B,searchArticlesSemantic:r}});function be(){const n=Sn();function t(){return n.loadArticles()}function a(){return n.loadCategories()}function b(){return n.getAllArticles()}function m(c){return n.getArticleById(c)}function h(c){return n.searchArticles(c)}function v(){return n.getPopularTags}function j(){return n.getArticlesByArchive}function C(){return n.categories.length>0?n.categories:n.getPopularTags}function A(c){return n.toggleLike(c)}function w(c){return n.getLikeStatus(c)}function g(c){return n.toggleBookmark(c)}function I(c){return n.getBookmarkStatus(c)}function x(){return n.getBookmarks()}function u(c){return n.getArticlesByTag(c)}function e(c){return n.searchArticlesSemantic(c)}function l(c){return n.getArticlesByCategory(c)}function d(){n.invalidateCache()}function r(){return n.getTotalViews()}return{loadArticles:t,loadCategories:a,getArticles:b,getArticle:m,searchArticles:h,getPopularTags:v,getArchive:j,getCategories:C,toggleLike:A,getLikeStatus:w,toggleBookmark:g,getBookmarkStatus:I,getBookmarks:x,invalidateCache:d,getArticlesByTag:u,searchArticlesSemantic:e,getArticlesByCategory:l,getTotalViews:r}}function he(n){return k.get(`/api/articles/${n}/comments`)}function fe(n,{content:t,parentId:a}){return k.post(`/api/articles/${n}/comments`,{content:t,parentId:a||void 0})}function Se(n,t){return k.put(`/api/comments/${n}`,{content:t})}function ye(n){return k.delete(`/api/comments/${n}`)}function je(n){return k.post("/api/admin/comments/batch-delete",{ids:n})}function Ce(n){return k.delete(`/api/comments/${n}/permanent`)}function we(n){return k.post(`/api/comments/${n}/like`)}function mn(n){return{id:n.id,articleId:n.article_id,parentId:n.parent_id||null,userId:n.user_id,username:n.username,userRole:n.user_role,content:n.content,options:{notify:!0,sticky:!!n.is_sticky},createdAt:n.created_at,updatedAt:n.updated_at,isDeleted:!!n.is_deleted,likes:n.likes||0,liked:!1,likedBy:[],avatarUrl:n.avatar_url||null}}const Ae=an("comment",()=>{const n=D({}),t=D(!1);async function a(e){t.value=!0;try{const l=await he(e);return l.data.success&&(n.value[e]=(l.data.data||[]).map(mn)),n.value[e]||[]}catch{return n.value[e]||[]}finally{t.value=!1}}function b(e){return n.value[e]||[]}function m(e){const l=b(e),d={},r=[];return l.forEach(c=>{d[c.id]={...c,replies:[]}}),l.forEach(c=>{c.parentId&&d[c.parentId]?d[c.parentId].replies.push(d[c.id]):r.push(d[c.id])}),r}async function h(e,l,d=null){const r=await fe(e,{content:l,parentId:d});if(r.data.success){const c=n.value[e]||[],L=mn(r.data.data);return n.value[e]=[L,...c],{success:!0,comment:L}}return{success:!1,message:r.data.message}}async function v(e,l){const d=await Se(e,l);return d.data.success?(Object.keys(n.value).forEach(r=>{const c=n.value[r],L=c.findIndex(N=>N.id===e);L!==-1&&(c[L]={...c[L],content:l})}),{success:!0}):{success:!1,message:d.data.message}}async function j(e){const l=await ye(e);return l.data.success?(Object.keys(n.value).forEach(d=>{n.value[d]=n.value[d].filter(r=>r.id!==e)}),{success:!0}):{success:!1,message:l.data.message}}async function C(e){var d;const l=await je(e);return l.data.success?(Object.keys(n.value).forEach(r=>{n.value[r]=n.value[r].filter(c=>!e.includes(c.id))}),{success:!0,deletedCount:(d=l.data.data)==null?void 0:d.deletedCount}):{success:!1,message:l.data.message}}async function A(e){const l=await Ce(e);return l.data.success?(Object.keys(n.value).forEach(d=>{n.value[d]=n.value[d].filter(r=>r.id!==e)}),{success:!0}):{success:!1,message:l.data.message}}async function w(e){const l=await w(e);return l.data.success?(Object.keys(n.value).forEach(d=>{const r=n.value[d],c=r.findIndex(L=>L.id===e);c!==-1&&(r[c]={...r[c],options:{...r[c].options,sticky:l.data.data.sticky}})}),{success:!0,sticky:l.data.data.sticky}):{success:!1,message:l.data.message}}async function g(e){const l=await we(e);return l.data.success?(Object.keys(n.value).forEach(d=>{const r=n.value[d],c=r.findIndex(L=>L.id===e);c!==-1&&(r[c]={...r[c],likes:l.data.data.likes,liked:l.data.data.liked})}),{success:!0,likes:l.data.data.likes,liked:l.data.data.liked}):{success:!1,message:l.data.message}}const I=P(()=>Object.values(n.value).reduce((e,l)=>e+l.length,0)),x=D(0);async function u(){try{const e=await pe();e.data.success&&(x.value=e.data.data.totalComments)}catch{}}return{articleComments:n,loading:t,totalCommentCount:I,totalCount:x,loadTotalCount:u,loadComments:a,getCachedComments:b,getCommentTree:m,addComment:h,updateComment:v,deleteComment:j,batchDeleteComments:C,permanentDeleteComment:A,toggleSticky:w,likeComment:g}});function xe(){const n=Ae();function t(u){return n.getCachedComments(u)}function a(u){return n.getCommentTree(u)}function b(u){return n.loadComments(u)}function m(u,e,l=null){return n.addComment(u,e,l)}function h(u,e){return n.updateComment(u,e)}function v(u){return n.deleteComment(u)}function j(u){return n.batchDeleteComments(u)}function C(u){return n.permanentDeleteComment(u)}function A(u){return n.toggleSticky(u)}function w(u){return n.likeComment(u)}function g(u){return n.getCachedComments(u).length}function I(){return n.totalCount}function x(){return n.loadTotalCount()}return{getComments:t,getCommentTree:a,loadComments:b,addComment:m,updateComment:h,deleteComment:v,batchDeleteComments:j,permanentDeleteComment:C,toggleSticky:A,likeComment:w,getCommentsCount:g,getTotalCommentCount:I,loadTotalCommentCount:x}}const Je={class:"blog-footer"},Ie={class:"footer-container"},Le={class:"footer-main"},Ee={class:"footer-section"},Oe={class:"social-links"},De={href:"https://github.com",target:"_blank",class:"social-link",title:"GitHub"},ke={href:"https://weibo.com",target:"_blank",class:"social-link",title:"微博"},Te={class:"footer-section"},Be={class:"site-stats"},Me={class:"stat-item"},Pe={class:"stat-num"},_e={class:"stat-item"},Re={class:"stat-num"},Ne={class:"stat-item"},Ue={class:"stat-num"},Fe={class:"stat-item"},Ve={class:"stat-num"},Ge={class:"footer-bottom"},He={class:"copyright"},Ke={class:"footer-links"},ze={__name:"Footer",setup(n){const t=vn(),{getArticles:a,getTotalViews:b}=be(),{getTotalCommentCount:m,loadTotalCommentCount:h}=xe(),v=()=>t.push("/contact"),j=P(()=>new Date().getFullYear()),C=P(()=>({articles:a().length,comments:m(),views:b(),days:Math.floor((Date.now()-new Date("2025-09-01").getTime())/864e5)}));Y(()=>h());const A=()=>window.scrollTo({top:0,behavior:"smooth"});return(w,g)=>{const I=sn,x=rn("router-link");return M(),_("footer",Je,[s("div",Ie,[s("div",Le,[s("div",Ee,[g[0]||(g[0]=s("h3",{class:"section-title"},[s("span",{class:"sys-prefix"},">"),E(" 关于本站 ")],-1)),g[1]||(g[1]=s("p",{class:"section-description"}," 一个个人博客，用于分享技术与生活感悟。 ",-1)),s("div",Oe,[s("a",De,[f(I,null,{default:y(()=>[f(T(kn))]),_:1})]),s("a",ke,[f(I,null,{default:y(()=>[f(T(Tn))]),_:1})]),s("a",{href:"#",class:"social-link",title:"邮箱",onClick:cn(v,["prevent"])},[f(I,null,{default:y(()=>[f(T(Bn))]),_:1})])])]),g[7]||(g[7]=Mn('<div class="footer-section" data-v-70213d91><h3 class="section-title" data-v-70213d91><span class="sys-prefix" data-v-70213d91>&gt;</span> 友情链接 </h3><ul class="friend-links" data-v-70213d91><li data-v-70213d91><a href="https://vuejs.org" target="_blank" class="friend-link" data-v-70213d91>&gt; Vue.js</a></li><li data-v-70213d91><a href="https://element-plus.org" target="_blank" class="friend-link" data-v-70213d91>&gt; Element Plus</a></li><li data-v-70213d91><a href="https://vitejs.dev" target="_blank" class="friend-link" data-v-70213d91>&gt; Vite</a></li><li data-v-70213d91><a href="https://github.com" target="_blank" class="friend-link" data-v-70213d91>&gt; GitHub</a></li></ul></div>',1)),s("div",Te,[g[6]||(g[6]=s("h3",{class:"section-title"},[s("span",{class:"sys-prefix"},">"),E(" 站点统计 ")],-1)),s("div",Be,[s("div",Me,[s("span",Pe,R(C.value.articles),1),g[2]||(g[2]=s("span",{class:"stat-label"},"文章",-1))]),s("div",_e,[s("span",Re,R(C.value.comments),1),g[3]||(g[3]=s("span",{class:"stat-label"},"评论",-1))]),s("div",Ne,[s("span",Ue,R(C.value.views),1),g[4]||(g[4]=s("span",{class:"stat-label"},"阅读",-1))]),s("div",Fe,[s("span",Ve,R(C.value.days),1),g[5]||(g[5]=s("span",{class:"stat-label"},"天",-1))])])])]),s("div",Ge,[s("div",He,[s("p",null,"© "+R(j.value)+" myBlog. All rights reserved.",1)]),s("div",Ke,[f(x,{to:"/contact",class:"footer-link-small"},{default:y(()=>[...g[8]||(g[8]=[E("> 联系我们",-1)])]),_:1}),f(x,{to:"/privacy",class:"footer-link-small"},{default:y(()=>[...g[9]||(g[9]=[E("> 隐私政策",-1)])]),_:1}),s("a",{href:"#",class:"footer-link-small",onClick:cn(A,["prevent"])},"> 回到顶部")])])])])}}},qe=Z(ze,[["__scopeId","data-v-70213d91"]]),$e={class:"back-to-top-content"},Qe={key:0,class:"back-to-top-text"},Xe={__name:"BackToTop",props:{visibilityHeight:{type:Number,default:300},bottom:{type:String,default:"40px"},right:{type:String,default:"40px"},duration:{type:Number,default:500},backgroundColor:{type:String,default:"var(--blog-primary-color)"},hoverBackgroundColor:{type:String,default:"var(--blog-primary-hover)"},color:{type:String,default:"white"},showText:{type:Boolean,default:!0},circular:{type:Boolean,default:!1},iconSize:{type:Number,default:20},size:{type:String,default:"default",validator:n=>["small","default","large"].includes(n)},container:{type:String,default:""},showOnMobile:{type:Boolean,default:!0}},emits:["click","visible-change"],setup(n,{emit:t}){const a=n,b=t,m=D(!1),h=D(!1),v=D(null),j=D(!1),C=P(()=>{const d={bottom:a.bottom,right:a.right,backgroundColor:a.backgroundColor,color:a.color};if(h.value&&a.hoverBackgroundColor&&(d.backgroundColor=a.hoverBackgroundColor),a.circular){const r={small:"40px",default:"48px",large:"56px"};d.width=r[a.size]||r.default,d.height=r[a.size]||r.default,d.borderRadius="50%"}return!a.showOnMobile&&j.value&&(d.display="none"),d}),A=()=>{j.value=window.innerWidth<768},w=()=>a.container&&document.querySelector(a.container)||window,g=()=>{const d=v.value;let r=0;d===window?r=window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop:r=d.scrollTop;const c=r>a.visibilityHeight;c!==m.value&&(m.value=c,b("visible-change",c))},I=()=>{const d=v.value,r=performance.now(),c=d===window?window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop:d.scrollTop,L=N=>{const G=N-r,F=Math.min(G/a.duration,1),B=c*(1-(o=>o<.5?4*o*o*o:1-Math.pow(-2*o+2,3)/2)(F));d===window?window.scrollTo(0,B):d.scrollTop=B,F<1&&requestAnimationFrame(L)};b("click"),requestAnimationFrame(L)},x=()=>{g()},u=()=>{A()},e=()=>{v.value=w(),A(),g(),v.value.addEventListener("scroll",x),window.addEventListener("resize",u)},l=()=>{v.value&&v.value.removeEventListener("scroll",x),window.removeEventListener("resize",u)};return Y(()=>{e()}),bn(()=>{l()}),(d,r)=>{const c=sn;return M(),Q(tn,{name:"fade"},{default:y(()=>[m.value?(M(),_("div",{key:0,class:X(["back-to-top",{"back-to-top-circular":n.circular}]),style:Pn(C.value),onClick:I,onMouseenter:r[0]||(r[0]=L=>h.value=!0),onMouseleave:r[1]||(r[1]=L=>h.value=!1)},[s("div",$e,[f(c,{size:n.iconSize,class:X({"icon-hovering":h.value})},{default:y(()=>[f(T(_n))]),_:1},8,["size","class"]),n.showText?(M(),_("span",Qe,"回到顶部")):V("",!0)])],38)):V("",!0)]),_:1})}}},We=Z(Xe,[["__scopeId","data-v-2e7b9eca"]]),Ye={class:"app-main"},Ze={class:"container"},nt={key:0,class:"global-loading"},et={class:"loading-counter"},tt={class:"counter-text"},at={__name:"Main",setup(n){const t=hn(),a=P(()=>["/login","/register"].includes(t.path)),b=D(!1),m=D(0),h=Sn();return Y(()=>{Promise.all([h.loadArticles(),h.loadCategories()])}),(v,j)=>{const C=rn("router-view");return M(),_("div",{class:X(["app-layout",{"is-auth-page":a.value}])},[s("main",Ye,[s("div",Ze,[f(C,null,{default:y(({Component:A})=>[f(tn,{name:"page-scan"},{default:y(()=>[(M(),Q(Rn(A)))]),_:2},1024)]),_:1})])]),f(We,{"visibility-height":300,"show-text":!1,circular:"",size:"default","show-on-mobile":!0}),f(tn,{name:"fade"},{default:y(()=>[b.value?(M(),_("div",nt,[s("div",et,[s("span",tt,R(m.value)+"%",1),j[0]||(j[0]=s("span",{class:"counter-cursor"},"_",-1))])])):V("",!0)]),_:1})],2)}}},rt=Z(at,[["__scopeId","data-v-3048efa0"]]),it={key:0},st={key:1},ot={__name:"App",setup(n){const t=hn(),a=["/login","/register","/404"],b=P(()=>!a.includes(t.path));return(m,h)=>(M(),_(en,null,[b.value?(M(),_("header",it,[f(ce)])):V("",!0),s("main",null,[f(rt)]),b.value?(M(),_("footer",st,[f(qe)])):V("",!0)],64))}},lt=[{path:"/",name:"Home",component:()=>J(()=>import("./Home-QgNUwQr0.js").then(n=>n.H),__vite__mapDeps([0,1,2,3]))},{path:"/about",name:"About",component:()=>J(()=>import("./About-BMZpJ9qd.js"),__vite__mapDeps([4,1,2,5]))},{path:"/article/:id",name:"Article",component:()=>J(()=>import("./Article-Cvg24f2f.js"),__vite__mapDeps([6,1,2,7,8,9,10])),props:!0},{path:"/tools",name:"Tools",component:()=>J(()=>import("./Tools-Crn8ETI3.js"),__vite__mapDeps([11,1,2,12,13]))},{path:"/projects",name:"Projects",component:()=>J(()=>import("./Projects-BuLq0DOQ.js"),__vite__mapDeps([14,1,2,15,16]))},{path:"/contact",name:"Contact",component:()=>J(()=>import("./Contact-Btz15D_s.js"),__vite__mapDeps([17,1,2,18]))},{path:"/login",name:"Login",component:()=>J(()=>import("./Login-DhFYCif8.js"),__vite__mapDeps([19,1,2,20]))},{path:"/register",name:"Register",component:()=>J(()=>import("./Register-2RF0GA0F.js"),__vite__mapDeps([21,1,2,22]))},{path:"/profile",name:"Profile",component:()=>J(()=>import("./Profile-BPAy1diG.js"),__vite__mapDeps([23,1,2,24,25])),meta:{requiresAuth:!0}},{path:"/bookmarks",name:"Bookmarks",component:()=>J(()=>import("./Bookmarks-DqOtFWQK.js"),__vite__mapDeps([26,1,2,27])),meta:{requiresAuth:!0}},{path:"/tags",name:"Tags",component:()=>J(()=>import("./Tags-pJFZjLVX.js"),__vite__mapDeps([28,1,2,24,29]))},{path:"/categories",name:"Categories",component:()=>J(()=>import("./Categories-ByAfvwDn.js"),__vite__mapDeps([30,1,2,24,31]))},{path:"/search",name:"Search",component:()=>J(()=>import("./Search-BOIVyYqH.js"),__vite__mapDeps([32,1,2,24,33]))},{path:"/rag",name:"RagQA",component:()=>J(()=>import("./RagQA-CBZSU5u_.js"),__vite__mapDeps([34,1,2,35]))},{path:"/archive",name:"Archive",component:()=>J(()=>import("./Archive-D2_j69Xa.js"),__vite__mapDeps([36,1,2,37]))},{path:"/interview",name:"Interview",component:()=>J(()=>import("./Interview-R6nFrOdb.js"),__vite__mapDeps([38,1,2,39,40]))},{path:"/interview/:category",name:"InterviewCategory",component:()=>J(()=>import("./InterviewCategory-Dt86ejNW.js"),__vite__mapDeps([41,1,2,39,42])),props:!0},{path:"/interview/:category/:id",name:"InterviewQuestion",component:()=>J(()=>import("./InterviewQuestion-DHTLzdZY.js"),__vite__mapDeps([43,1,2,39,8,9,44])),props:!0},{path:"/admin",name:"Admin",component:()=>J(()=>import("./Admin-BdsHg7CT.js"),__vite__mapDeps([45,1,2,12,39,46])),meta:{requiresAdmin:!0}},{path:"/:pathMatch(.*)*",name:"NotFound",component:()=>J(()=>import("./NotFound-DQKjBcsr.js"),__vite__mapDeps([47,1,2,48]))}],$=Nn({history:Un("/myBlog/"),routes:lt,scrollBehavior(n,t,a){return a||{top:0}}});$.beforeEach(async(n,t)=>{const a=fn();if(n.meta.requiresAuth||n.meta.requiresAdmin){if(a.token&&!a.user&&await a.restoreSession(),!a.isAuthenticated)return"/login";if(n.meta.requiresAdmin&&!a.isAdmin)return"/"}return!0});const ct=Object.freeze(Object.defineProperty({__proto__:null,default:$},Symbol.toStringTag,{value:"Module"}));async function ut(){const n=Fn(ot);n.use(Vn()),n.use($),await $.isReady();const t=sessionStorage.getItem("spa-redirect");t&&(sessionStorage.removeItem("spa-redirect"),await $.replace(t)),n.mount("#app")}ut();export{O as S,Z as _,J as a,Xn as b,xe as c,be as d,k as e,nn as f,pt as g,gt as h,ye as i,dn as j,gn as r,pn as s,Sn as u};
