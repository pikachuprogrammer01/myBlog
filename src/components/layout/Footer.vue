    ...
    <div class="footer-container">
      ...
      <div class="footer-main">
        ...
        <div class="footer-section">
          ...
          <p class="section-description">
            一个基于 Vue 3 + Element Plus 构建的静态博客，用于分享技术与生活感悟。
          </p>
          <div class="social-links">
            ...
            <a href="mailto:example@example.com" class="social-link" title="邮箱">
        ...
        <div class="footer-section">
          ...
          <ul class="friend-links">
            ...
            <li>
              <a href="https://element-plus.org" target="_blank" class="friend-link">
      ...
      <div class="footer-bottom">
        <div class="copyright">
          ...
          <p class="copyright-extra">
            <el-icon><Warning /></el-icon>
            本网站为演示项目，数据仅存储在本地浏览器中。
          </p>
        </div>
        <div class="footer-links">
          ...
          <router-link to="/sitemap" class="footer-link-small">
...
const initStats = () => {
  ...
  stats.value = {
    ...
    views: 15642, // 模拟数据
    days: Math.floor((Date.now() - new Date('2025-01-01').getTime()) / (1000 * 60 * 60 * 24))
  }
}
